                                        ...
                                        <ul class="dropdown-menu mega_dropdown" role="menu" style="width: 830px;">
                                            <li class="block-container col-sm-3">
                                                <ul class="block">
                                                    <li class="img_container">
                                                        <a href="#">
                                                            <img class="img-responsive" src="{{url('/')}}/public/front-end/assets/data/men.png" alt="sport">
                                                        </a>
                                                    </li>
                                            ...
                                            <li class="block-container col-sm-3">
                                                <ul class="block">
                                                    <li class="img_container">
                                                        <a href="#">
                                                            <img class="img-responsive" src="{{url('/')}}/public/front-end/assets/data/women.png" alt="sport">
                                                        </a>
                                                    </li>
                                                    <li class="link_container group_header">
                                                        <a href="#">WOMEN'S</a>
                                            ...
                                            <li class="block-container col-sm-3">
                                                <ul class="block">
                                                    <li class="img_container">
                                                        <a href="#">
                                                            <img class="img-responsive" src="{{url('/')}}/public/front-end/assets/data/kid.png" alt="sport">
                                                        </a>
                                                    </li>
                                                    <li class="link_container group_header">
                                                        <a href="#">Kids</a>
                                            ...
                                            <li class="block-container col-sm-3">
                                                <ul class="block">
                                                    <li class="img_container">
                                                        <a href="#">
                                                            <img class="img-responsive" src="{{url('/')}}/public/front-end/assets/data/trending.png" alt="sport">
                                                        </a>
                                                    </li>
                                                    <li class="link_container group_header">
                                                        <a href="#">TRENDING</a>
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="mega_dropdown dropdown-menu" style="width: 830px;">
                                            ...
                                            <li class="block-container col-sm-3">
                                                <ul class="block">
                                                    <li class="img_container">
                                                        <img src="{{url('/')}}/public/front-end/assets/data/banner-topmenu.jpg" alt="Banner">
                                                    </li>
                                                </ul>
                                            </li>
...
{{--<div id="header" class="header">--}}
    {{--<div class="top-header">--}}
        {{--<div class="container">--}}
            {{--<div class="nav-top-links">--}}
                {{--<a class="first-item" href="#"><img alt="phone" src="{{url('/')}}/public/front-end/assets/images/phone.png" />0964245027</a>--}}
                {{--<a href="#"><img alt="email" src="{{url('/')}}/public/front-end/assets/images/email.png" />Hãy liên hệ với chúng tôi</a>--}}
            {{--</div>--}}
            {{--<div class="currency ">--}}
                {{--<div class="dropdown">--}}
                    {{--<a class="current-open" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#">USD</a>--}}
    ...
    {{--<div class="container main-header">--}}
        {{--<div class="row">--}}
            {{--<div class="col-xs-12 col-sm-3 logo">--}}
                {{--<a href="index.html"><img alt="Kute Shop" src="{{url('/')}}/public/front-end/assets/images/logo.png" /></a>--}}
            {{--</div>--}}
            {{--<div class="col-xs-7 col-sm-7 header-search-box">--}}
                {{--<form class="form-inline">--}}
                    {{--<div class="form-group form-category">--}}
            ...
            {{--<div class="row">--}}
                {{--<div class="col-sm-3" id="box-vertical-megamenus">--}}
                    {{--<div class="box-vertical-megamenus">--}}
                        ...
                        {{--<div class="vertical-menu-content is-home">--}}
                            {{--<ul class="vertical-menu-list">--}}
                                {{--<li><a href="category.html"><img class="icon-menu" alt="Funky roots" src="{{url('/')}}/public/front-end/assets/data/1.png">Electronics</a></li>--}}
                                {{--<li>--}}
                                    {{--<a class="parent" href="category2.html"><img class="icon-menu" alt="Funky roots" src="{{url('/')}}/public/front-end/assets/data/2.png">Sports &amp; Outdoors</a>--}}
                                    {{--<div class="vertical-dropdown-menu">--}}
                                        {{--<div class="vertical-groups col-sm-12">--}}
                                            {{--<div class="mega-group col-sm-4">--}}
                                                {{--<h4 class="mega-group-header"><span>Tennis</span></h4>--}}
                                            ...
                                            {{--</div>--}}
                                            {{--<div class="mega-custom-html col-sm-12">--}}
                                                {{--<a href="#"><img src="{{url('/')}}/public/front-end/assets/data/banner-megamenu.jpg" alt="Banner"></a>--}}
                                            {{--</div>--}}
                                        {{--</div>--}}
                                    {{--</div>--}}
                                {{--</li>--}}
                                {{--<li><a href="category.html"><img class="icon-menu" alt="Funky roots" src="{{url('/')}}/public/front-end/assets/data/3.png">Smartphone &amp; Tablets</a></li>--}}
                                {{--<li><a href="category2.html"><img class="icon-menu" alt="Funky roots" src="{{url('/')}}/public/front-end/assets/data/4.png">Health &amp; Beauty Bags</a></li>--}}
                                {{--<li>--}}
                                    {{--<a class="parent" href="category.html">--}}
                                        {{--<img class="icon-menu" alt="Funky roots" src="{{url('/')}}/public/front-end/assets/data/5.png">Shoes &amp; Accessories</a>--}}
                                    {{--<div class="vertical-dropdown-menu">--}}
                                        {{--<div class="vertical-groups col-sm-12">--}}
                                            {{--<div class="mega-group col-sm-12">--}}
                                                {{--<h4 class="mega-group-header"><span>Special products</span></h4>--}}
                                                {{--<div class="row mega-products">--}}
                                                    {{--<div class="col-sm-3 mega-product">--}}
                                                        {{--<div class="product-avatar">--}}
                                                            {{--<a href="#"><img src="{{url('/')}}/public/front-end/data/p10.jpg" alt="product1"></a>--}}
                                                        {{--</div>--}}
                                                        {{--<div class="product-name">--}}
                                                            {{--<a href="#">Fashion hand bag</a>--}}
                                                        {{--</div>--}}
                                    ...
                                    {{--</div>--}}
                                {{--</li>--}}
                                {{--<li><a href="category.html"><img class="icon-menu" alt="Funky roots" src="{{url('/')}}/public/front-end/assets/data/6.png">Toys &amp; Hobbies</a></li>--}}
                                {{--<li><a href="category.html"><img class="icon-menu" alt="Funky roots" src="{{url('/')}}/public/front-end/assets/data/7.png">Computers &amp; Networking</a></li>--}}
                                {{--<li><a href="category.html"><img class="icon-menu" alt="Funky roots" src="{{url('/')}}/public/front-end/assets/data/8.png">Laptops &amp; Accessories</a></li>--}}
                                {{--<li><a href="category.html"><img class="icon-menu" alt="Funky roots" src="{{url('/')}}/public/front-end/assets/data/9.png">Jewelry &amp; Watches</a></li>--}}
                                {{--<li><a href="category.html"><img class="icon-menu" alt="Funky roots" src="{{url('/')}}/public/front-end/assets/data/10.png">Flashlights &amp; Lamps</a></li>--}}
                                {{--<li>--}}
                                    {{--<a href="category.html">--}}
                                        {{--<img class="icon-menu" alt="Funky roots" src="{{url('/')}}/public/front-end/assets/data/11.png">--}}
                                        {{--Cameras &amp; Photo--}}
                                    {{--</a>--}}
                                {{--</li>--}}
                                {{--<li class="cat-link-orther">--}}
                                    {{--<a href="category.html">--}}
                                        {{--<img class="icon-menu" alt="Funky roots" src="{{url('/')}}/public/front-end/assets/data/5.png">--}}
                                        {{--Television--}}
                                    {{--</a>--}}
                                {{--</li>--}}
                                {{--<li class="cat-link-orther">--}}
                                    {{--<a href="category.html">--}}
                                        {{--<img class="icon-menu" alt="Funky roots" src="{{url('/')}}/public/front-end/assets/data/7.png">Computers &amp; Networking--}}
                                    {{--</a>--}}
                                {{--</li>--}}
                                {{--<li class="cat-link-orther">--}}
                                    {{--<a href="category.html">--}}
                                        {{--<img class="icon-menu" alt="Funky roots" src="{{url('/')}}/public/front-end/assets/data/6.png">--}}
                                        {{--Toys &amp; Hobbies--}}
                                    {{--</a>--}}
                                {{--</li>--}}
                                {{--<li class="cat-link-orther">--}}
                                    {{--<a href="category.html"><img class="icon-menu" alt="Funky roots" src="{{url('/')}}/public/front-end/assets/data/9.png">Jewelry &amp; Watches</a></li>--}}
                            {{--</ul>--}}
                            {{--<div class="all-category"><span class="open-cate">All Categories</span></div>--}}
                        {{--</div>--}}
                    {{--</div>--}}
                                ...
                                {{--<ul class="nav navbar-nav">--}}
                                    ...
                                    {{--<li class="dropdown">--}}
                                            {{--@if($menus['parent_id'] == 0)--}}
                                                {{--<a href="category.html" class="dropdown-toggle" data-toggle="dropdown">{{ $menus['name'] }}</a>--}}
                                            {{--@endif--}}
                                        {{--@foreach($menu as $item)--}}
                                            {{--@if($item['parent_id'] == $menus['id'])--}}
                                        {{--<ul class="dropdown-menu container-fluid">--}}
                                            {{--<li class="block-container">--}}
                                                {{--<ul class="block">--}}
                                                    {{--<li class="link_container"><a href="#">{{ $item['name'] }}</a></li>--}}
                                                {{--</ul>--}}
                                            {{--</li>--}}
                                        {{--</ul>--}}
                                             {{--@endif--}}
